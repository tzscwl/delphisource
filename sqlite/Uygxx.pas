...
uses
  udm, umain, Uygadd,Uygedit;
{$R *.dfm}

procedure Tfygxx.act_addExecute(Sender: TObject);
begin
 inherited;
  fygadd := Tfygadd.Create(self);
  fygadd.ShowModal;
  fygadd.Free;
end;
...
procedure Tfygxx.act_editExecute(Sender: TObject);
begin
  inherited;
  fygedit:= Tfygedit.Create(self);
  fygedit.ShowModal;
  fygedit.Free;
end;
